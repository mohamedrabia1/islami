abstract class AppAssets{
  ...
  static const icQuran = "${imagePath}ic_quran.png";
  static const icAhades = "${imagePath}ic_ahades.png";
  static const icRadio = "${imagePath}ic_radio.png";
  static const icSebha = "${imagePath}ic_sebha.png";
